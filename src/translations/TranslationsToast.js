const toastTranslate = {
    en: {
        ...
        select_at_least_one_client: "Select at least one client",
        name_is_required: "Name is required!",
        name_does_not_match_with_the_platform:
            "Entered Name does not match with the shown platform name",
        platform_created_successfully: "Platform created successfully.",
        group_joined_successfully: "Group joined successfully.",
        "": "",
    },
    jp: {
        loading: "読み込み中...",
        ...
        select_at_least_one_client:
            "少なくとも1つのクライアントを選択してください",
        name_is_required: "名前は必須です！",
        name_does_not_match_with_the_platform:
            "入力された名前が表示されているプラットフォーム名と一致しません",
        platform_created_successfully:
            "プラットフォームが正常に作成されました。",
        group_joined_successfully: "グループが正常に参加しました。",
        "": "",
    },
};
